...
void AArch64AsmPrinter::emitInstruction(const MachineInstr* MI) {
  ...
  case AArch64::HINT: {
    ...
    break;
                    ...
                    //   // It is generally beneficial to rewrite "fmov s0, wzr" to "movi d0,
                    //   #0".
                    //   // as movi is more efficient across all cores. Newer cores can
                    //   eliminate
                    //   // fmovs early and there is no difference with movi, but this not true
                    //   for
                    //   // all implementations.
                    //   //
                    //   // The floating-point version doesn't quite work in rare cases on older
                    //   // CPUs, so on those targets we lower this instruction to movi.16b
                    //   instead. if (STI->hasZeroCycleZeroingFPWorkaround() &&
                    ...
                    //     ExceptionHandling ExceptionHandlingType =
                    //     MAI->getExceptionHandlingType(); if (ExceptionHandlingType !=
                    ...
                    //   MO_TLSDESC_LO12.setTargetFlags(AArch64II::MO_TLS |
                    //   AArch64II::MO_PAGEOFF); MO_TLSDESC.setTargetFlags(AArch64II::MO_TLS |
                    //   AArch64II::MO_PAGE); MCInstLowering.lowerOperand(MO_Sym, Sym);
                    ...
                    //   if (MI->getOperand(1).getImm() == 30 && MI->getOperand(0).getImm() >=
                    //   19 &&
